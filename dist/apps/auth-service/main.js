...
exports.AuthServiceModule = AuthServiceModule = __decorate([
    (0, common_1.Module)({
        imports: [
            ...
            common_2.RmqModule.register({ name: 'AUTH' }),
        ],
...
let AuthServiceService = class AuthServiceService {
    constructor(userRepository, rmqClient) {
...
exports.AuthServiceService = AuthServiceService = __decorate([
    ...
    __param(1, (0, common_1.Inject)('AUTH')),
...
/***/ "./libs/common/src/constants/tier.constants.ts":
/*!*****************************************************!*\
  !*** ./libs/common/src/constants/tier.constants.ts ***!
  \*****************************************************/
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.TierLimits = exports.AccountTier = void 0;
var AccountTier;
(function (AccountTier) {
    AccountTier["TIER_1"] = "TIER_1";
    AccountTier["TIER_2"] = "TIER_2";
    AccountTier["TIER_3"] = "TIER_3";
})(AccountTier || (exports.AccountTier = AccountTier = {}));
exports.TierLimits = {
    [AccountTier.TIER_1]: {
...
__exportStar(__webpack_require__(/*! ./rmq.module */ "./libs/common/src/rmq.module.ts"), exports);
__exportStar(__webpack_require__(/*! ./rmq.service */ "./libs/common/src/rmq.service.ts"), exports);
__exportStar(__webpack_require__(/*! ./constants/tier.constants */ "./libs/common/src/constants/tier.constants.ts"), exports);


/***/ }),

/***/ "./libs/common/src/rmq.module.ts":
/*!***************************************!*\
  !*** ./libs/common/src/rmq.module.ts ***!
  \***************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
const microservices_1 = __webpack_require__(/*! @nestjs/microservices */ "@nestjs/microservices");
const rmq_service_1 = __webpack_require__(/*! ./rmq.service */ "./libs/common/src/rmq.service.ts");
                ...
                microservices_1.ClientsModule.registerAsync([
                    {
                        ...
                        useFactory: (configService) => ({
                            ...
                            options: {
                                urls: [configService.get('RABBIT_MQ_URI') || 'amqp://localhost:5672'],
...
/***/ "./libs/common/src/rmq.service.ts":
/*!****************************************!*\
  !*** ./libs/common/src/rmq.service.ts ***!
  \****************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
let RmqService = class RmqService {
    ...
    getOptions(queue, noAck = false) {
        return {
            transport: microservices_1.Transport.RMQ,
            options: {
                urls: [this.configService.get('RABBIT_MQ_URI') || 'amqp://localhost:5672'],
...
const common_1 = __webpack_require__(/*! @libs/common */ "./libs/common/src/index.ts");
